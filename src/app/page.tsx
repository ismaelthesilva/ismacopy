      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        ...
        <div className="relative container mx-auto px-4 py-20 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center text-white">
            <img src="/images/codeBaseLogoSquare2.png" alt="Base Logic Labs Logo" className="mx-auto mb-6 w-24 h-24 rounded-2xl shadow-lg border-4 border-white/20 bg-white/10" />
            ...
            <p className="text-xl sm:text-2xl mb-6 opacity-90 leading-relaxed text-gray-200 font-medium">
              Bridging Silicon Valley-grade engineering and sales psychology.<br />
              <span className="text-lg text-blue-200">We architect revenue engines for ambitious SaaS founders and enterprise teams.</span>
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-10">
              <Button asChild size="lg" className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white font-bold text-lg px-8 py-4 shadow-2xl hover:shadow-blue-500/25 transition-all duration-300">
                <Link href="/contact">
                  Start Your Project
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-8">
              <div className="bg-white/10 rounded-xl p-4 shadow-md">
                <div className="text-lg font-bold text-blue-200 mb-1">Studio Model</div>
                <div className="text-sm text-gray-100">Elite teams, structured delivery, no freelancer chaos.</div>
              </div>
              <div className="bg-white/10 rounded-xl p-4 shadow-md">
                <div className="text-lg font-bold text-blue-200 mb-1">Product Mindset</div>
                <div className="text-sm text-gray-100">Every line of code is a business decision. We build for outcomes.</div>
              </div>
              <div className="bg-white/10 rounded-xl p-4 shadow-md">
                <div className="text-lg font-bold text-blue-200 mb-1">Authority</div>
                <div className="text-sm text-gray-100">Led by Ismael Silva, global SaaS & enterprise delivery expert.</div>
              </div>
            </div>
            <div className="mt-8 text-sm text-gray-300">
              <span className="font-semibold">HQ:</span> New Zealand &bull; <span className="font-semibold">Serving:</span> US & Global Clients
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            {services.map((service, index) => (
              <Card key={index} className="bg-card border hover:border-primary/30 transition-all duration-300 hover:shadow-xl">
                <CardHeader>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            {technologies.map((tech, index) => (
              <Card key={index} className="text-center bg-card border hover:border-primary/30 transition-all duration-300 hover:shadow-lg">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {testimonials.map((testimonial, index) => (
              <Card key={index} className="bg-card/80 backdrop-blur-md border hover:border-primary/30 text-foreground hover:bg-card/90 transition-all duration-300">
                <CardHeader>
                  <div className="flex items-center gap-4 mb-4">
